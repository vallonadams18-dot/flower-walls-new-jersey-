    ...
    <>
      ...
      <section className="bg-bloom-50">
        <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href={SITE.booking.collection} className="rounded-full border border-bloom-300 px-6 py-3 font-medium hover:bg-white transition-colors">
              Check availability
            </a>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14">
        ...
        <ol className="mt-6 grid gap-8 sm:grid-cols-3">
          <li>
            <span className="font-[family-name:var(--font-display)] text-bloom-600 text-3xl">1</span>
            <h3 className="mt-1 font-medium">Pick the wall</h3>
            <p className="mt-1 text-ink/75">
              Any of our {walls.length} designs — matched to your colours and
              event. <Link href="/flower-walls/" className="text-bloom-600 hover:underline underline-offset-4">View flower walls</Link>.
            </p>
          </li>
          <li>
            <span className="font-[family-name:var(--font-display)] text-bloom-600 text-3xl">2</span>
            <h3 className="mt-1 font-medium">Pick the booth</h3>
            <p className="mt-1 text-ink/75">
              Mirror, 360, glam, digital, video or branded. <Link href="/photo-booths/" className="text-bloom-600 hover:underline underline-offset-4">Explore photo booths</Link>.
            </p>
          </li>
          <li>
            <span className="font-[family-name:var(--font-display)] text-bloom-600 text-3xl">3</span>
      ...
      <section className="bg-bloom-50">
        <div className="mx-auto max-w-6xl px-4 py-12">
          ...
          <ul className="mt-4 grid gap-4 sm:grid-cols-2 text-ink/80">
            ...
            <li><strong>Branded booth + custom logo wall</strong> — the activation setup, with data capture. <Link href="/events/corporate/" className="text-bloom-600 hover:underline underline-offset-4">Corporate events</Link>.</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14">
        <div className="flex items-end justify-between gap-4">
          ...
          <Link href="/flower-walls/" className="text-bloom-600 hover:underline underline-offset-4 shrink-0">All {walls.length} walls →</Link>
        </div>
        <div className="mt-6 grid gap-8 grid-cols-2 lg:grid-cols-4">
          {featured.map((w) => <WallCard key={w.slug} wall={w} />)}
        </div>
        <div className="mt-10 rounded-xl bg-bloom-50 p-6 sm:p-8">
          ...
          <a href={SITE.booking.contact} className="mt-4 inline-block rounded-full bg-bloom-600 px-6 py-3 text-white font-medium hover:bg-bloom-700 transition-colors">
            Get a quote
          </a>
        </div>
      </section>
